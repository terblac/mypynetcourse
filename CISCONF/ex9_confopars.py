'''
Use the cisconfoparse library to find the crypto maps that are using pfs group2
'''
...
def main():
    '''
    Use the ciscoconfparse library to find the crypto maps that are usign pfs group2
    '''
